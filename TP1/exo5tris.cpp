...
int main(int argc, char** argv) {
    ...
    // Cela permet de pouvoir modifier le vbo en passant par GL_ARRAY_BUFFER
     ...
     // On a un tableau GLfloat contenant ses coordonnées Vertex3DColor
    Vertex3DColor vertices[] = {
        Vertex3DColor(glm::vec3(-0.5, 0.5, 0.), glm::vec3(1, 0, 0)), // Premier sommet : coordonnées + couleur
        Vertex3DColor(glm::vec3(-0.5, -0.5, 0.), glm::vec3(0, 1, 0)), // Deuxième sommet : coordonnées + couleur
        Vertex3DColor(glm::vec3(0.5, -0.5, 0.), glm::vec3(0, 0, 1)), // Troisième sommet : coordonnées + couleur
        Vertex3DColor(glm::vec3(-0.5, 0.5, 0.), glm::vec3(1, 0, 0)), 
        Vertex3DColor(glm::vec3(0.5, -0.5, 0.), glm::vec3(0, 0, 1)), 
        Vertex3DColor(glm::vec3(0.5, 0.5, 0.), glm::vec3(0, 1, 0)),
        //Deuxième face
        Vertex3DColor(glm::vec3(-0.5, 0.5, 1.), glm::vec3(1, 0, 0)), 
        Vertex3DColor(glm::vec3(0.5, -0.5, 1.), glm::vec3(0, 0, 1)), 
        Vertex3DColor(glm::vec3(0.5, 0.5, 1.), glm::vec3(0, 1, 0)),
        Vertex3DColor(glm::vec3(-0.5, 0.5, 1.), glm::vec3(1, 0, 0)), 
        Vertex3DColor(glm::vec3(0.5, -0.5, 1.), glm::vec3(0, 0, 1)), 
        Vertex3DColor(glm::vec3(0.5, 0.5, 1.), glm::vec3(0, 1, 0)) 
    };
    ...
    indices.push_back(1);
     ...
     // offsetof(Vertex3DColor, position) = décalage en octets de la premiere instance de l'attribut dans le tableau (casté en GLvoid*))
     glVertexAttribPointer(VERTEX_ATTR_POSITION, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex3DColor), (const GLvoid*)offsetof(Vertex3DColor, position));
